...
namespace Extension
{
    ...
    {
        public const string GUID = "certifiedcactus.ultrakill.ut_extension";
        public const string Name = "Un-Nerfer";
        ...
        public void Start()
        {
            ...
            SettingUIHandler.Pages.Add($"{GUID}.ext_page", new SettingUIHandler.Page("EXTENSION: UN-NERF"));
